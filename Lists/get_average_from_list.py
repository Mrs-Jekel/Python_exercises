...
# NoSQL database is not a sql database :) 

# they have formats and very flexible 
# fields can be created dynamically with unique characteristics 
# (if you have unstructured data)
# BISON code looks like json code
