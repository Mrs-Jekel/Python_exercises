...
greeting('Morning',
         ...
         second = 'Take puppy out',
         third = 'math homework')
         
#          """
# #list of steps 

# # FUNCTION- start with a positional arg time of day and give a single star for the name and
# #  then double star for kwargs (behavior we are looking for print greeting to user and go
# #  through key value pair)         
# # GREETING- print-formatted string-inside string literal join statement and takes in full
# #  set of args which takes in the users(first name last name ect)
